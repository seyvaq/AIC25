(function () {
  ...
  $(window)
    .on("resize.myTemplate", function () {
      $("body")[$(this).width() <= 991 ? "addClass" : "removeClass"](
        "isMobile",
      );
    })
   ...
   *----------------------- TO TOP ----------------------
   */
  $(window).on("scroll.myTemplate", scrollWindow).trigger("sctoll.myTemplate");
  ...
  if ($(".main-slider")[0]) {
    $(".main-slider")
      .slick({
        ...
        autoplaySpeed: 4500,
        nextArrow:
          '<span class="slick-arrow-next"><i class="fa fa-caret-right" aria-hidden="true"></i></span>',
        prevArrow:
          '<span class="slick-arrow-prev"><i class="fa fa-caret-left" aria-hidden="true"></i></span>',
      })
  ...
  if ($(".main-slider-two")[0]) {
    $(".main-slider-two")
      .slick({
        ...
        touchThreshold: 100,
        nextArrow:
          '<span class="slick-arrow-next"><i class="fas fa-caret-right"></i></span>',
        prevArrow:
          '<span class="slick-arrow-prev"><i class="fas fa-caret-left"></i></span>',
